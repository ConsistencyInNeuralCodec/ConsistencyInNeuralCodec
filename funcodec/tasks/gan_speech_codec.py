...
from funcodec.models.quantizer.costume_quantizer import CostumeQuantizer, CostumeQuantizerRaw
...
quantizer_choices = ClassChoices(
    ...
    classes=dict(
        ...
        costume_quantizer_raw=CostumeQuantizerRaw,
    ),
    type_check=torch.nn.Module,
...
class GANSpeechCodecTask(AbsTask):
    ...
    def add_task_arguments(cls, parser: argparse.ArgumentParser):
        ...
        group.add_argument(
            "--get_speech_length_while_speech_max_length",
            type=bool,
            default=True,
        )
        group.add_argument(
            "--clip_audio_from_left_side",
            type=bool,
            default=None,
        )
        group.add_argument(
    ...
    def build_preprocess_fn(
        ...
        if args.use_preprocessor:
            ...
            retval = CodecPreprocessor(
                ...
                get_speech_length_while_speech_max_length=getattr(args, "get_speech_length_while_speech_max_length", True),
                clip_audio_from_left_side=getattr(args, "clip_audio_from_left_side", None),
                clip_ds_rate=getattr(args, "clip_ds_rate", None),
            )
        else:
            retval = None
