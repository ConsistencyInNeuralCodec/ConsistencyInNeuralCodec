...
class ScaledPositionalEncoding(PositionalEncoding):
    ...
    def __init__(self, d_model, dropout_rate, max_len=5000, alpha_requires_grad=True):
        """Initialize class."""
        super().__init__(d_model=d_model, dropout_rate=dropout_rate, max_len=max_len)
        self.alpha = torch.nn.Parameter(torch.tensor(1.0), requires_grad=alpha_requires_grad)
