...
class TransformerEncoderConfig(PretrainedConfig):
    def __init__(
        self,
        enc_emb_tokens: Optional[torch.FloatTensor] = None,
        encoder_layer: Optional[int] = 4,
        encoder_hidden: Optional[int] = 256,
        encoder_head: Optional[int] = 4,
        conv_filter_size: Optional[int] = 1024,
        conv_kernel_size: Optional[int] = 5,
        encoder_dropout: Optional[float] = 0.1,
        use_cln: Optional[bool] = False,
        cfg: Optional[Any] = None,
        **kwargs
    ):
        super().__init__(
            enc_emb_tokens=enc_emb_tokens,
