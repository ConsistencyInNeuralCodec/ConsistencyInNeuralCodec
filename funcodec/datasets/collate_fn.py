...
from funcodec.modules.nets_utils import pad_list, pad_list_all_dim, pad_list_with_mod
...
def common_collate_fn(
...
) -> Tuple[List[str], Dict[str, Union[list, torch.Tensor]]]:
    ...
    for key in data[0]:
        ...
        if key not in not_sequence:
            ...
            # print(666, key, array_list[0].shape, lens)
