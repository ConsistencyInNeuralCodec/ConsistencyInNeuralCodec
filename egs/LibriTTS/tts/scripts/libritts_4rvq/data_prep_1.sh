#! /usr/bin/env bash
# bash /home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/tts/scripts/libritts_4rvq/data_prep_1.sh
...
dump_dir=${dump_root}/4rvq/encodec_16k_n4_ds320_largev8
