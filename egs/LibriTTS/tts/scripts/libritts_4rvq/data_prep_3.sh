#! /usr/bin/env bash
# bash /home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/tts/scripts/libritts_4rvq/data_prep_3.sh
...
dump_dir=${dump_root}/4rvq/encodec_16k_n4_ds320_largev8_phase_aug_consistent_0.2_quant_in_10.0
