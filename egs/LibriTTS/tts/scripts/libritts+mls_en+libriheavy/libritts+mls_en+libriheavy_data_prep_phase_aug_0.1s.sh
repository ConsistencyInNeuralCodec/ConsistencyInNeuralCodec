#! /usr/bin/env bash
# bash /home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/tts/scripts/libritts+mls_en+libriheavy/libritts+mls_en+libriheavy_data_prep_phase_aug_0.1s.sh
...
codec_model_name=encodec_16k_n16_ds320_largev8_phase_aug_consistent_0.1s_quant_in_10.0_encodec

# dump_dir=${dump_root}/${codec_model_name}
dump_dir=${dump_root}/16rvq/encodec_16k_n16_ds320_largev8_phase_aug_consistent_0.1s_quant_in_10.0_encodec
