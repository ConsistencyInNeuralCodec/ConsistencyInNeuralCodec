...
# bash /home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/tts/scripts/valle_libritts+mls_en+libriheavy/valle_n8_encodec_16kHz_n8/submit.sh
...
codec_dir=/home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS+MLS_en+LibriHeavy/codec/dump/8rvq/encodec_16k_n8_ds320_largev8_encodec
...
# not used
codec_model_dir=/home/admin_data/user/checkpoints/funcodec_consistency_encodec_8rvq_LibriTTS+MLS_en/exp/encodec_16k_n8_ds320_largev8_encodec


# training related
# tag="valle_n8_encodec_16kHz_n8"
tag="valle_n8_encodec_16kHz_n8-0707"
train_set=train
valid_set=dev
