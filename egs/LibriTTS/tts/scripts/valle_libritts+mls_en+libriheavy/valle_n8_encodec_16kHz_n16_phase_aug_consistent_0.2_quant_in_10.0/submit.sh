...
# bash /home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/tts/scripts/valle_libritts+mls_en+libriheavy/valle_n8_encodec_16kHz_n16_phase_aug_consistent_0.2_quant_in_10.0/submit.sh
...
exp_dir=/home/admin_data/user/checkpoints/funcodec_valle_libritts+mls_en+libriheavy
...
# tag="valle_n8_encodec_16kHz_n16-2gpu"
train_set=train
valid_set=dev
