#! /usr/bin/env bash
# bash /home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/tts/scripts/libritts_semantic_hubert/data_prep_1.sh
...
codec_model_root=/home/admin_data/user/checkpoints/funcodec_semantic_encodec_16rvq/exp
...
codec_model_name=encoder_16k_n16_ds320_largev8_semantic_hubert                                 # 1
...
dump_dir=${dump_root}/16rvq/encodec_16k_n16_ds320_largev8_semantic_hubert
