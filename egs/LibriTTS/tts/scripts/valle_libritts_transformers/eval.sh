...
# bash /home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/tts/scripts/valle_libritts_transformers/eval.sh

model_name=valle_16k_n8_ds320valle_n8_encodec_16kHz_n16
# model_name=valle_16k_n8_ds320valle_n8_encodec_16kHz_n16-wb200
# model_name=valle_16k_n8_ds320valle_n8_encodec_16kHz_n16_phase_aug_consistent_0.2_quant_in_10.0

# model_name=valle_16k_n8_ds320_adalnvalle_n8_encodec_16kHz_n16
# model_name=valle_16k_n8_ds320_adalnvalle_n8_encodec_16kHz_n16_phase_aug_consistent_0.2_quant_in_10.0
...
# model_inference_dir=inference/15epoch.pth/${test_sets}
# model_inference_dir=inference_-100_-50/25epoch.pth/${test_sets}
# model_inference_dir=inference_-175_-125/25epoch.pth/${test_sets}
# model_inference_dir=inference_-225_-125/25epoch.pth/${test_sets}
# model_inference_dir=inference/28epoch.pth/${test_sets}
# model_inference_dir=inference/30epoch.pth/${test_sets}
model_inference_dir=inference/25epoch.pth/${test_sets}
# model_inference_dir=inference/50epoch.pth/${test_sets}
# model_inference_dir=inference/59epoch.pth/${test_sets}
# model_inference_dir=inference/60epoch.pth/${test_sets}
# model_inference_dir=inference/90epoch.pth/${test_sets}

# exp_dir=/home/admin_data/user/checkpoints/funcodec_valle_libritts_merge
exp_dir=/home/admin_data/user/checkpoints/funcodec_valle_libritts_transformers

# model_dir=${exp_dir}/exp/${model_name}
# model_dir=${exp_dir}/exp_lr0.005_wb2000/${model_name}
model_dir=${exp_dir}/exp_nar_bidirection/${model_name}
