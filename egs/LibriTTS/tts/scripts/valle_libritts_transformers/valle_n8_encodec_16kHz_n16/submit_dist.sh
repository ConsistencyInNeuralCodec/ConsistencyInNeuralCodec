...
# bash /home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/tts/scripts/valle_libritts_transformers/valle_n8_encodec_16kHz_n16/submit_dist.sh
...
CODE_ROOT=/home/admin_data/user/checkpoints/funcodec_valle_libritts_transformers/${CODE_REPO}
mkdir -p ${CODE_ROOT}
...
codec_dir=/home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/codec/dump2/16rvq/encodec_16k_n16_ds320_largev8
exp_dir=/home/admin_data/user/checkpoints/funcodec_valle_libritts_transformers
...
# not used
codec_model_dir=/home/admin_data/user/checkpoints/funcodec_consistency_encodec_LibriTTS+MLS_en/exp/encoder_16k_n16_ds320_largev8_encodec_0518


# training related
# tag="valle_n8_encodec_16kHz_n16"
tag="valle_n8_encodec_16kHz_n16_dist"
# tag="valle_n8_encodec_16kHz_n16-lr0.005"
# tag="valle_n8_encodec_16kHz_n16-wb200"
# tag="valle_n8_encodec_16kHz_n16-1gpu"
train_set=train
valid_set=dev
