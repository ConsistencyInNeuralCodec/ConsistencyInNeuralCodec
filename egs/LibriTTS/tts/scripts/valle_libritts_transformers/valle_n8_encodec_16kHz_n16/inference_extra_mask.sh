#! /usr/bin/env bash
# bash /home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/tts/scripts/valle_libritts_transformers/valle_n8_encodec_16kHz_n16/inference_extra_mask.sh
...
# testset_dir=/home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/tts/testset/testsetA_slim
...
# inference_tag="inference_-100_-50"
inference_tag="inference_-175_-125"
# inference_tag="inference_-225_-125"

batch_size=1
test_sets="testsetA"
# test_sets="testsetA_slim"
...
asr_exp=${exp_dir}/exp_nar_bidirection/${model_dir}
