#! /usr/bin/env bash
# bash /home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/tts/scripts/libritts+mls_en+libriheavy_8rvq/data_prep_1-2gpu.sh
...
codec_model_root=/home/admin_data/user/checkpoints/funcodec_consistency_encodec_8rvq_LibriTTS+MLS_en/exp
inference_model=7epoch.pth
corpus_dir=LibriTTS+MLS_en+LibriHeavy
dump_root=/home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/${corpus_dir}/codec/dump
dataset_root=/home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/${corpus_dir}/tts

codec_model_name=encodec_16k_n8_ds320_largev8_encodec                                 # 1
# codec_model_name=encoder_16k_n8_ds320_largev8_consistent_0.2_quant_in_10.0_encodec             # 2
# codec_model_name=encoder_16k_n8_ds320_largev8_phase_aug_consistent_0.2_quant_in_10.0_encodec   # 3
# codec_model_name=encoder_16k_n8_ds320_largev8_consistent_0.4_quant_in_10.0_encodec             # 4
# codec_model_name=encoder_16k_n8_ds320_largev8_phase_aug_consistent_0.4_quant_in_10.0_encodec   #5

# dump_dir=${dump_root}/${codec_model_name}
# dump_dir=${dump_root}/8rvq/${codec_model_name}
dump_dir=${dump_root}/8rvq/${codec_model_name}-2gpu
