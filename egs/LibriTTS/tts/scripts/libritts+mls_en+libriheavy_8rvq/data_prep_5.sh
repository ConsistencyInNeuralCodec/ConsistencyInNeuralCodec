#! /usr/bin/env bash
# bash /home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/tts/scripts/libritts+mls_en+libriheavy_8rvq/data_prep_5.sh
...
# codec_model_name=encodec_16k_n8_ds320_largev8_consistent_0.2_quant_in_10.0_encodec             # 2
# codec_model_name=encodec_16k_n8_ds320_largev8_phase_aug_consistent_0.2_quant_in_10.0_encodec   # 3
# codec_model_name=encodec_16k_n8_ds320_largev8_consistent_0.4_quant_in_10.0_encodec             # 4
codec_model_name=encodec_16k_n8_ds320_largev8_phase_aug_consistent_0.4_quant_in_10.0_encodec   #5
