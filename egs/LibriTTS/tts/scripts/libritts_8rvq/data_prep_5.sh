#! /usr/bin/env bash
# bash /home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/tts/scripts/libritts_8rvq/data_prep_5.sh
...
# codec_model_name=encodec_16k_n8_ds320_largev8_encodec
# codec_model_name=encodec_16k_n8_ds320_largev8_consistent_0.2_quant_in_10.0_encodec
# codec_model_name=encodec_16k_n8_ds320_largev8_phase_aug_consistent_0.2_quant_in_10.0_encodec
# codec_model_name=encodec_16k_n8_ds320_largev8_consistent_0.4_quant_in_10.0_encodec
codec_model_name=encodec_16k_n8_ds320_largev8_phase_aug_consistent_0.4_quant_in_10.0_encodec

# dump_dir=${dump_root}/${codec_model_name}
# dump_dir=${dump_root}/8rvq-4epoch/encodec_16k_n8_ds320_largev8_phase_aug_consistent_0.2_quant_in_10.0
dump_dir=${dump_root}/8rvq/encodec_16k_n8_ds320_largev8_phase_aug_consistent_0.4_quant_in_10.0
