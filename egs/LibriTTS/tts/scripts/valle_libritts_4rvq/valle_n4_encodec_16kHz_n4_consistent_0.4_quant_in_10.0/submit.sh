...
# bash /home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/tts/scripts/valle_libritts_4rvq/valle_n4_encodec_16kHz_n4_consistent_0.4_quant_in_10.0/submit.sh
...
# training related
tag=valle_n4_encodec_16kHz_n4_consistent_0.4_quant_in_10.0
train_set=train
valid_set=dev
