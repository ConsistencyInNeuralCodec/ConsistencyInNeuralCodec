#! /usr/bin/env bash
# bash /home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/tts/scripts/valle_libritts_4rvq/valle_n4_encodec_16kHz_n4_phase_aug_consistent_0.4_quant_in_10.0/inference.sh
...
codec_model_dir=/home/admin_data/user/checkpoints/funcodec_consistency_encodec_4rvq_LibriTTS+MLS_en/exp/encodec_16k_n4_ds320_largev8_phase_aug_consistent_0.4_quant_in_10.0_encodec
