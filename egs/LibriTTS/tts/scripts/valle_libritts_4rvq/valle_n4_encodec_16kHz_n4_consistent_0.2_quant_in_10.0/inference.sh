#! /usr/bin/env bash
# bash /home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/tts/scripts/valle_libritts_4rvq/valle_n4_encodec_16kHz_n4_consistent_0.2_quant_in_10.0/inference.sh
