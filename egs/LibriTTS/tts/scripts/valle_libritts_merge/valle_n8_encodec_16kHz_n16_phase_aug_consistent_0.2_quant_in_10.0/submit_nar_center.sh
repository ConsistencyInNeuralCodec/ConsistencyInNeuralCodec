...
# bash /home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/tts/scripts/valle_libritts_merge/valle_n8_encodec_16kHz_n16_phase_aug_consistent_0.2_quant_in_10.0/submit_nar_center.sh
...
CODE_ROOT=/home/admin_data/user/checkpoints/funcodec_valle_libritts_merge/${CODE_REPO}
mkdir -p ${CODE_ROOT}
...
tag="valle_n8_encodec_16kHz_n16_phase_aug_consistent_0.2_quant_in_10.0-nar_center"
