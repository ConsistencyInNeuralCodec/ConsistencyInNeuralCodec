...
# bash /home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/tts/scripts/valle_libritts_merge/valle_n8_encodec_16kHz_n16_phase_aug_consistent_0.2_quant_in_10.0/submit-sort.sh
...
CODE_ROOT=/home/admin_data/user/checkpoints/funcodec_valle_libritts_dist/${CODE_REPO}
mkdir -p ${CODE_ROOT}
...
tokens_dir=/home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/dataset/LibriTTS_dist
codec_dir=/home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS_dist/codec/dump/16rvq/encodec_16k_n16_ds320_largev8_phase_aug_consistent_0.2_quant_in_10.0
exp_dir=/home/admin_data/user/checkpoints/funcodec_valle_libritts_dist
...
# not used
codec_model_dir=/home/admin_data/user/checkpoints/funcodec_consistency_encodec_LibriTTS+MLS_en/exp/encoder_16k_n16_ds320_largev8_phase_aug_consistent_0.2_quant_in_10.0_encodec


# training related
# tag="valle_n8_encodec_16kHz_n16_phase_aug_consistent_0.2_quant_in_10.0"
tag="valle_n8_encodec_16kHz_n16_phase_aug_consistent_0.2_quant_in_10.0-transformers"
# tag="valle_n8_encodec_16kHz_n16_phase_aug_consistent_0.2_quant_in_10.0-1gpu"
train_set=train
# train_set=dev
valid_set=dev
# train_config=/home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/tts/conf/valle/valle_16k_n8_ds320.yaml
# train_config=/home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/tts/conf/valle/merge/valle_16k_n8_ds320.yaml
train_config=/home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/tts/conf/valle/transformers/valle_16k_n8_ds320.yaml
...
for ((i = 0; i < $gpu_num; ++i)); do
    {
        ...
        python -m funcodec.bin.tts_train \
            ...
            --train_data_path_and_name_and_type ${codec_dir}/${train_set}/dist.scp,dist,kaldi_ark \
            ...
            --valid_data_path_and_name_and_type ${codec_dir}/${valid_set}/dist.scp,dist,kaldi_ark \
