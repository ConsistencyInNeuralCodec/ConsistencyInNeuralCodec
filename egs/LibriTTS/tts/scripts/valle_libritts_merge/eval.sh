...
# model_name=valle_16k_n8_ds320valle_n8_encodec_16kHz_n16-nar_center
# model_name=valle_16k_n8_ds320valle_n8_encodec_16kHz_n16_phase_aug_consistent_0.2_quant_in_10.0-nar_center

# model_inference_dir=inference/23epoch.pth/testsetA
# model_inference_dir=inference/25epoch.pth/testsetA
# model_inference_dir=inference/30epoch.pth/testsetA
# model_inference_dir=inference/40epoch.pth/testsetA
# model_inference_dir=inference/55epoch.pth/testsetA
# model_inference_dir=inference/59epoch.pth/testsetA
model_inference_dir=inference/60epoch.pth/testsetA
# model_inference_dir=inference/100epoch.pth/testsetA
