#! /usr/bin/env bash
# bash /home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/tts/scripts/valle_libritts_8rvq/valle_n8_encodec_16kHz_n8_phase_aug_consistent_0.2_quant_in_10.0/inference.sh
