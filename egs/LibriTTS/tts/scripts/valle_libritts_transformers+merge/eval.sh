...
# bash /home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/tts/scripts/valle_libritts_transformers+merge/eval.sh

model_name=valle_16k_n8_ds320valle_n8_encodec_16kHz_n16
# model_name=valle_16k_n8_ds320valle_n8_encodec_16kHz_n16_dropout
# model_name=valle_16k_n8_ds320valle_n8_encodec_16kHz_n16-2
...
# model_inference_dir=inference/29epoch.pth/${test_sets}
# model_inference_dir=inference/27epoch.pth/${test_sets}
# model_inference_dir=inference/35epoch.pth/${test_sets}
# model_inference_dir=inference/45epoch.pth/${test_sets}
# model_inference_dir=inference/43epoch.pth/${test_sets}
# model_inference_dir=inference/50epoch.pth/${test_sets}
# model_inference_dir=inference/60epoch.pth/${test_sets}
# model_inference_dir=inference/100epoch.pth/${test_sets}

# exp_dir=/home/admin_data/user/checkpoints/funcodec_valle_libritts_merge
exp_dir=/home/admin_data/user/checkpoints/funcodec_valle_libritts_transformers+merge

# model_dir=${exp_dir}/exp/${model_name}
# model_dir=${exp_dir}/exp_lr0.005_wb200/${model_name}
