...
# bash /home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/tts/scripts/valle_libritts_transformers+merge/valle_n8_encodec_16kHz_n16_phase_aug_consistent_0.2_quant_in_10.0/submit_adaln.sh
...
CODE_ROOT=/home/admin_data/user/checkpoints/funcodec_valle_libritts_transformers+merge/${CODE_REPO}
mkdir -p ${CODE_ROOT}
...
train_config=/home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/tts/conf/valle/transformers+merge/valle_16k_n8_ds320_adaln.yaml
