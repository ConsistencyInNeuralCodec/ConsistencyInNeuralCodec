#! /usr/bin/env bash
# bash /home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/tts/scripts/valle_libritts_transformers+merge/valle_n8_encodec_16kHz_n16/inference_dropout.sh
...
# tag=valle_n8_encodec_16kHz_n16-2
...
# inference_model=29epoch.pth
# inference_model=27epoch.pth
...
# asr_exp=${exp_dir}/exp_lr0.005_wb200/${model_dir}
