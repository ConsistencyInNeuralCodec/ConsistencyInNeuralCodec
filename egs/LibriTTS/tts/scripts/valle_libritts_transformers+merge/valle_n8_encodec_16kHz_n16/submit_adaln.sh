...
# bash /home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/tts/scripts/valle_libritts_transformers+merge/valle_n8_encodec_16kHz_n16/submit_adaln.sh
