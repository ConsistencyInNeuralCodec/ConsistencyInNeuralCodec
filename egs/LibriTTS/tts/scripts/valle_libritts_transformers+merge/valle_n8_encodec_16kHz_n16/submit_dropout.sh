...
# bash /home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/tts/scripts/valle_libritts_transformers+merge/valle_n8_encodec_16kHz_n16/submit_dropout.sh
...
# training related
tag="valle_n8_encodec_16kHz_n16_dropout"
train_set=train
valid_set=dev
...
train_config=/home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/tts/conf/valle/transformers+merge+dropout/valle_16k_n8_ds320.yaml
