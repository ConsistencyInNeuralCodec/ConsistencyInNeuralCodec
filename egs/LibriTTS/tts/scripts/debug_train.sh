...
# training related
tag="uniaudio_libritts_debug"
train_set=train
valid_set=dev
train_config=/home/admin_data/renjun.admin/projects/FunCodec-Dev/egs/LibriTTS/tts/conf/uniaudio_16k_n8_ds320_a100_debug.yaml
init_param=
