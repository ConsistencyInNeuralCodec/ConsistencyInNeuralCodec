...
# bash /home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/tts/scripts/encodec_16rvq_valle_n4/valle_n4_encodec_16kHz_n16_phase_aug_consistent_0.4_quant_in_10.0/submit.sh
...
CODE_ROOT=/home/admin_data/user/checkpoints/funcodec_valle_libritts+mls_en+libriheavy/${CODE_REPO}
mkdir -p ${CODE_ROOT}
...
tokens_dir=/home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/dataset/LibriTTS+MLS_en+LibriHeavy
codec_dir=/home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS+MLS_en+LibriHeavy/codec/dump/16rvq/encodec_16k_n16_ds320_largev8_phase_aug_consistent_0.4_quant_in_10.0
exp_dir=/home/admin_data/user/checkpoints/funcodec_valle_n4_encodec_n16_libritts+mls_en+libriheavy
...
# not used
codec_model_dir=/home/admin_data/user/checkpoints/funcodec_consistency_encodec_LibriTTS+MLS_en/exp/encoder_16k_n16_ds320_largev8_phase_aug_consistent_0.4_quant_in_10.0_encodec


# training related
tag="valle_n4_encodec_16kHz_n16_phase_aug_consistent_0.4_quant_in_10.0"
train_set=train
valid_set=dev
train_config=/home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/tts/conf/valle/valle_16k_n4_ds320.yaml
