#! /usr/bin/env bash
# bash /home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/tts/scripts/encodec_16rvq_valle_n4/valle_n4_encodec_16kHz_n16_phase_aug_consistent_0.2_quant_in_10.0/inference.sh
...
corpus_dir=LibriTTS+MLS_en+LibriHeavy # not used
seed=0
...
# codec_model_dir=/home/admin_data
