...
# bash /home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/tts/scripts/valle_libritts/valle_n8_encodec_16kHz_n16_semantic_hubert/eval.sh
...
model_name=valle_16k_n8_ds320encodec_16k_n16_ds320_largev8_semantic_hubert-4gpu

# model_inference_dir=inference/6epoch.pth/testsetA
model_inference_dir=inference/44epoch.pth/testsetA
