#! /usr/bin/env bash
# bash /home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/tts/scripts/valle_libritts/valle_n8_encodec_16kHz_n16_semantic_hubert/inference.sh
...
codec_model_dir=/home/admin_data/user/checkpoints/funcodec_semantic_encodec_16rvq/exp/encoder_16k_n16_ds320_largev8_semantic_hubert
