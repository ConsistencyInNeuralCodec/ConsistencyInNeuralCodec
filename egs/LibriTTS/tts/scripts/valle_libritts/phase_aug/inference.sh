#! /usr/bin/env bash
# bash /home/admin_data//mnt/workspace/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/tts/scripts/valle_libritts/phase_aug/inference.sh
...
# training related
tag=_phase_aug_10.0
codec_model_dir=/home/admin_data/user/checkpoints/funcodec_consistency_encodec_LibriTTS+MLS_en/phase_aug_weight/exp/phase_aug_1.0_encodec
...
codec_inference_model=1epoch.pth
...
asr_exp=${exp_dir}/phase_aug/exp/${model_dir}
