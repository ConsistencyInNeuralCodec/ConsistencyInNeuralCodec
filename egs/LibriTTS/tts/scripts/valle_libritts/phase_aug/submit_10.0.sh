...
# bash /home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/tts/scripts/valle_libritts/phase_aug/submit_10.0.sh
...
model_name=phase_aug_10.0
tokens_dir=/home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/dataset/LibriTTS
codec_dir=/home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/codec/dump2/16rvq/${model_name}_encodec
exp_dir=/home/admin_data/user/checkpoints/funcodec_valle_libritts/phase_aug
...
# not used
codec_model_dir=/home/admin_data/user/checkpoints/funcodec_consistency_encodec_LibriTTS+MLS_en/exp/encoder_16k_n16_ds320_largev8_phase_aug_consistent_encodec
...
# train_config=/home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/codec/conf/user/16rvq_encodec_LibriTTS+MLS_en/phase_aug_weight/${model_name}.yaml
