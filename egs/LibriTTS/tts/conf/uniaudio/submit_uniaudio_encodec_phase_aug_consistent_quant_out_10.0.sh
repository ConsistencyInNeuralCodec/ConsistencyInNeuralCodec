...
# bash /home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/tts/conf/uniaudio/submit_uniaudio_encodec_phase_aug_consistent_quant_out_10.0.sh
...
CODE_ROOT=/home/admin_data/user/checkpoints/funcodec_uniaudio/${CODE_REPO}
# mkdir -p ${CODE_ROOT}
