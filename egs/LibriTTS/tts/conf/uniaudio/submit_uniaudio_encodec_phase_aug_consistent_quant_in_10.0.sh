...
# bash /home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/tts/conf/uniaudio/submit_uniaudio_encodec_phase_aug_consistent_quant_in_10.0.sh
