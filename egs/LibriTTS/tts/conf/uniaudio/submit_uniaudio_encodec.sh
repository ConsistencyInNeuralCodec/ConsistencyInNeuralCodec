...
# bash /home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/tts/conf/uniaudio/submit_uniaudio_encodec.sh
...
# training related
tag="uniaudio_encodec_LibriTTS_16rvq"
train_set=train
valid_set=dev
