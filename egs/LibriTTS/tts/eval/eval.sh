...
# bash /home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/tts/eval/eval.sh

# model_dir=/home/admin_data/user/checkpoints/funcodec_valle_libritts+mls_en+libriheavy/exp/valle_16k_n8_ds320valle_n8_encodec_16kHz_n16
# model_dir=/home/admin_data/user/checkpoints/funcodec_valle_libritts+mls_en+libriheavy/exp/valle_16k_n8_ds320valle_n8_encodec_16kHz_n16_phase_aug_consistent_0.2_quant_in_10.0
# model_dir=/home/admin_data/user/checkpoints/funcodec_valle_libritts+mls_en+libriheavy/exp/valle_16k_n8_ds320valle_n8_encodec_16kHz_n16_phase_aug_consistent_0.4_quant_in_10.0

# 8rvq
model_dir=/home/admin_data/user/checkpoints/funcodec_valle_libritts+mls_en+libriheavy_8rvq/exp/valle_16k_n8_ds320valle_n8_encodec_16kHz_n8-0707
model_dir=/home/admin_data/user/checkpoints/funcodec_valle_libritts+mls_en+libriheavy_8rvq/exp/valle_16k_n8_ds320valle_n8_encodec_16kHz_n8_phase_aug_consistent_0.2_quant_in_10.0

model_inference_dir=inference/1epoch.pth/testsetA
# model_inference_dir=inference/2epoch.pth/testsetA
# model_inference_dir=inference/3epoch.pth/testsetA
