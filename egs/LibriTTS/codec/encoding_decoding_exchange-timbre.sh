...
# out_dir=$model_dir/assess_1epoch-exchange_timbre/gen_wavs
# model_path=${model_dir}/1epoch.pth

# out_dir=$model_dir/assess_2epoch-exchange_timbre/gen_wavs
# model_path=${model_dir}/2epoch.pth

# out_dir=$model_dir/assess_3epoch-exchange_timbre/gen_wavs
# model_path=${model_dir}/3epoch.pth

# out_dir=$model_dir/assess_4epoch-exchange_timbre/gen_wavs
# model_path=${model_dir}/4epoch.pth

# out_dir=$model_dir/assess_5epoch-exchange_timbre/gen_wavs
# model_path=${model_dir}/5epoch.pth

# out_dir=$model_dir/assess_9epoch-exchange_timbre/gen_wavs
# model_path=${model_dir}/9epoch.pth

out_dir=$model_dir/assess_10epoch-exchange_timbre/gen_wavs
model_path=${model_dir}/10epoch.pth

# out_dir=$model_dir/assess_15epoch-exchange_timbre/gen_wavs
# model_path=${model_dir}/15epoch.pth

# out_dir=$model_dir/assess_20epoch-exchange_timbre/gen_wavs
# model_path=${model_dir}/20epoch.pth

# out_dir=$model_dir/assess_25epoch-exchange_timbre/gen_wavs
# model_path=${model_dir}/25epoch.pth

speech_id2speech_id=/home/admin_data/user/dataset/scp/LibriTTS/16kHz/test-clean_exchange-timbre.txt
speech_id2wav_fn=/home/admin_data/user/dataset/scp/LibriTTS/16kHz/test-clean_exchange-timbre.scp

# speech_id2speech_id=/home/admin_data/user/dataset/scp/LibriTTS/16kHz/test-clean_exchange-timbre1.txt
# speech_id2wav_fn=/home/admin_data/user/dataset/scp/LibriTTS/16kHz/test-clean_exchange-timbre1.scp
# out_dir=$model_dir/assess_15epoch-exchange_timbre1/gen_wavs
# model_path=${model_dir}/15epoch.pth

wav_scp=$speech_id2wav_fn
...
if [ ${stage} -eq 1 ]; then
    ...
    ${infer_cmd} --gpu "${_ngpu}" --max-jobs-run "${_nj}" JOB=1:"${_nj}" "${_logdir}"/inference.JOB.log \
        python -m funcodec.bin.codec_inference_2 \
            ...
            --need_sub_quants false \
            --use_scale false  \
            --exchange_timbre --speech_id2speech_id $speech_id2speech_id --speech_id2wav_fn $speech_id2wav_fn \
