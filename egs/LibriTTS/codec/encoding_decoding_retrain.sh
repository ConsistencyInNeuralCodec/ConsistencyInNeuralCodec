...
wav_scp=/mnt/workspace/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/codec/dump/LJSpeech/test/wav.scp

model_dir=/mnt/workspace/user/checkpoints/funcodec/exp/freqcodec_mag2timefreq2wav
# model_dir=/home/admin_data/user/checkpoints/funcodec/exp/freqcodec_mag2time-retrain_decoder_freq2wav-decoder-ljspeech
# model_dir=/home/admin_data/user/checkpoints/funcodec/exp/freqcodec_mag2time-retrain_decoder_freq2wav-decoder-libritts+ljspeech
...
out_dir=$model_dir/assess_30epoch/gen_wavs
model_path=${model_dir}/30epoch.pth

# out_dir=$model_dir/assess_33epoch/gen_wavs
# model_path=${model_dir}/33epoch.pth
