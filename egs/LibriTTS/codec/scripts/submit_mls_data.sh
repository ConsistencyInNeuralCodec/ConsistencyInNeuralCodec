#! /bin/bash
# bash /home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/codec/scripts/submit_mls_data.sh

dataset_name=MLS
dataset_root=/home/admin_data/user/dataset/MLS_English
audio_format=.flac
...
do
    ...
    cd $feats_dir
    find $dataset_root/$subset -iname *${audio_format} | awk -F '/' '{print $(NF),$0}' | sort > $feats_dir/dump/$dataset_name/$subset/wav.scp
