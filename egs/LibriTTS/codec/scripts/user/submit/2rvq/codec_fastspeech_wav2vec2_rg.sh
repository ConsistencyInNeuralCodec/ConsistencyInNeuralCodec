...
# 执行命令: bash /home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/codec/scripts/user/submit/2rvq/codec_fastspeech_wav2vec2_rg.sh
...
train_config=/home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/codec/conf/user/2rvq/freqcodec_mag2time_fastspeech_wav2vec2_rg.yaml
init_param=
