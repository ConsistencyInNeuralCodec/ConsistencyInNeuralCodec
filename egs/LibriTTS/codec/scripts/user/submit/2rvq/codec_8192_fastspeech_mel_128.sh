...
# 执行命令: bash /home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/codec/scripts/user/submit/2rvq/codec_8192_fastspeech_mel_128.sh
...
train_set=train
valid_set=dev
train_config=/home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/codec/conf/user/2rvq/freqcodec_mag2time_8192_fastspeech_meanpooling_mel_128.yaml
init_param=
