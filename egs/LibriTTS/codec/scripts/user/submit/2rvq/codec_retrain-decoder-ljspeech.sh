...
# 执行命令: bash /home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/codec/scripts/user/submit/2rvq/codec_retrain-decoder-ljspeech.sh
...
dumpdir="LJSpeech"
state_dir="LJSpeech_states"

# training related
# tag="freq2wav"
tag="_freq2wav-decoder-ljspeech"
train_set=train
valid_set=dev
