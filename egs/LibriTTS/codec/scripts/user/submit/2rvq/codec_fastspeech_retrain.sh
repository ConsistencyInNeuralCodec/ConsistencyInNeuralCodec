...
# 执行命令: bash /home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/codec/scripts/user/submit/2rvq/codec_fastspeech_retrain.sh
...
# mel2ph_file="/home/admin_data/user/dataset/libritts/mel2ph_ds640.jsonl"
...
train_config=/home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/codec/conf/user/2rvq/freqcodec_mag2time_fastspeech_retrain.yaml
init_param=
...
# copy ckpt files
ori_model_dir=/home/admin_data/user/checkpoints/funcodec/exp/freqcodec_mag2time_fastspeechfreq2wav
