...
# 执行命令: bash /home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/codec/scripts/user/submit/2rvq/codec_retrain-decoder-libritts+ljspeech.sh
...
dataset_name="LibriTTS+LJSpeech"
dumpdir="LibriTTS+LJSpeech"
state_dir="LibriTTS+LJSpeech_states"

# training related
# tag="freq2wav"
tag="_freq2wav-decoder-libritts+ljspeech"
train_set=train
valid_set=dev
# train_config=/home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/codec/conf/user/2rvq/freqcodec_mag2time.yaml
...
train_config=/home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/codec/conf/user/2rvq/freqcodec_mag2time-retrain_decoder.yaml
init_param=
...
# copy ckpt files
ori_model_dir=/home/admin_data/user/checkpoints/funcodec/exp/freqcodec_mag2timefreq2wav
cp -ar $ori_model_dir/checkpoint.pth ${exp_dir}/exp/${model_dir}/
echo "copy checkpoint.pth"
