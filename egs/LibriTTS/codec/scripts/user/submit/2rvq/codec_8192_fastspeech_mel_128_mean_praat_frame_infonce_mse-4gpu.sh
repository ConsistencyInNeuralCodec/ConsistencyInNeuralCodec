...
# 执行命令: bash /home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/codec/scripts/user/submit/2rvq/codec_8192_fastspeech_mel_128_mean_praat_frame_infonce_mse-4gpu.sh
...
# training related
# tag="_freq2wav"
tag="_freq2wav-4gpu-a"
# tag="_0.2_freq2wav"
train_set=train
valid_set=dev
# train_config=/home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/codec/conf/user/2rvq/freqcodec_mag2time_8192_fastspeech_meanpooling_mel_128_praat_frame_infonce_mse.yaml
train_config=/home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/codec/conf/user/2rvq/freqcodec_mag2time_8192_xvector_unfreeze_praat_frame_infonce.yaml
init_param=
