...
# 执行命令: bash /home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/codec/scripts/user/submit/2rvq/codec_8192_conformer_qformer1_vqvc_plus_phoneme_cl.sh
...
speaker_id_dir="/home/admin_data/user/dataset/libritts/speaker_id"
...
train_config=/home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/codec/conf/user/2rvq/freqcodec_mag2time_8192_conformer_qformer1_vqvc_phoneme_cl_cosine.yaml
init_param=
...
# hard copy
funcodec_root=/home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/funcodec
cp -ar $funcodec_root ${exp_dir}/exp/${model_dir}/
