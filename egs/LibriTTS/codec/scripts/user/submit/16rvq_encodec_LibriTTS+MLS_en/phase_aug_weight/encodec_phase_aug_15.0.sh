...
# 执行命令: bash /home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/codec/scripts/user/submit/16rvq_encodec_LibriTTS+MLS_en/phase_aug_weight/encodec_phase_aug_15.0.sh
...
exp_dir=/home/admin_data/user/checkpoints/funcodec_consistency_encodec_LibriTTS+MLS_en/phase_aug_weight
# dataset_name=LibriTTSAll
# dumpdir=LibriTTSAll
# state_dir=LibriTTSAll_states
dataset_name=LibriTTS+MLS_en
dumpdir=LibriTTS+MLS_en
state_dir=LibriTTS+MLS_en_states
...
train_set=train
valid_set=dev
# train_config=/home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/codec/conf/user/16rvq_encodec_LibriTTS+MLS_en/encoder_16k_n16_ds320_largev8_phase_aug.yaml
train_config=/home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/codec/conf/user/16rvq_encodec_LibriTTS+MLS_en/phase_aug_weight/phase_aug_15.0.yaml
init_param=/home/admin_data/user/checkpoints/funcodec_consistency_encodec_LibriTTS+MLS_en/exp/encoder_16k_n16_ds320_largev8_phase_aug_encodec/5epoch.pth
    ...
    for ((i = 0; i < $gpu_num; ++i)); do
        {
            ...
            python -m funcodec.bin.codec_train \
                ...
                --train_data_path_and_name_and_type ${feats_dir}/dump/${dumpdir}/${train_set}/wav.scp,speech,sound \
                --train_shape_file ${feats_dir}/exp/${state_dir}/${train_set}/speech_shape \
                --valid_data_path_and_name_and_type ${feats_dir}/dump/${dumpdir}/${valid_set}/wav.scp,speech,sound \
