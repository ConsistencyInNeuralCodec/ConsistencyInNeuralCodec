...
# 执行命令: bash /home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/codec/scripts/user/submit/16rvq_encodec_LibriTTS+MLS_en/encodec_16k_n16_ds320_largev8_consistent_0.2_quant_in_10.0.sh
...
train_set=train
valid_set=dev
train_config=/home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/codec/conf/user/16rvq_encodec_LibriTTS+MLS_en/encoder_16k_n16_ds320_largev8_consistent_0.2_quant_in_10.0.yaml
init_param=
