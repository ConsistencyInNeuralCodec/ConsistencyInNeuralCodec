...
# 执行命令: bash /home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/codec/scripts/user/submit/contrastive/codec_1rvq_quant64_fastspeech_sicf.sh
...
train_config=/home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/codec/conf/user/contrastive/freqcodec_mag2time_1rvq_quant64_fastspeech_sicf.yaml
init_param=
