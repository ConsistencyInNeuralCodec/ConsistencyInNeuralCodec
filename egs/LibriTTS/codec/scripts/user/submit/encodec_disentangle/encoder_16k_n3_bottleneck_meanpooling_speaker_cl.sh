...
# 执行命令: bash /home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/codec/scripts/user/submit/encodec_disentangle/encoder_16k_n3_bottleneck_meanpooling_speaker_cl.sh
...
exp_dir=/home/admin_data/user/checkpoints/funcodec_encodec_disentangle
...
train_set=train
valid_set=dev
train_config=/home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/codec/conf/user/encodec_disentangle/encoder_16k_n3_bottleneck_meanpooling_speaker_cl.yaml
init_param=
