...
# 执行命令: bash /home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/codec/scripts/user/submit/16rvq_encodec/qformer1_praat_infonce/encodec_largev8_16k_n16_ds320_fastspeech_mel_qformer1_praat_frame.sh
...
# exp_dir=/home/admin_data/user/checkpoints/funcodec_consistency_encodec
exp_dir=/home/admin_data/user/checkpoints/funcodec_consistency_encodec_LibriTTS+MLS_en
...
train_set=train
valid_set=dev
# train_config=/home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/codec/conf/user/freqcodec_mag2time.yaml
...
train_config=/home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/codec/conf/user/16rvq_encodec/qformer1_praat_infonce/encodec_largev8_16k_n16_ds320_fastspeech_mel_qformer1_praat_frame.yaml
init_param=
