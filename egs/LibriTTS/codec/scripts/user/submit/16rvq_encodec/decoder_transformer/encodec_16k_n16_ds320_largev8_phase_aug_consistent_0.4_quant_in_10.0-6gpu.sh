...
# 执行命令: bash /home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/codec/scripts/user/submit/16rvq_encodec/decoder_transformer/encodec_16k_n16_ds320_largev8_phase_aug_consistent_0.4_quant_in_10.0-6gpu.sh
