...
# 执行命令: bash /home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/codec/scripts/user/submit/codec_quant64.sh
...
# training related
# tag="freq2wav"
tag="freq2wav-quant64"
train_set=train
valid_set=dev
train_config=/home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/codec/conf/user/freqcodec_mag2time_quant64.yaml
