...
# 执行命令: bash /home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/codec/scripts/user/submit/2rvq_encodec/encodec_8192_fastspeech_mel_qformer1_rg.sh
...
train_config=/home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/codec/conf/user/2rvq_encodec/encodec_8192_fastspeech_mel_qformer1_rg.yaml
init_param=
