...
# 执行命令: bash /home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/codec/scripts/user/submit/2rvq_encodec/encodec_16k_n6_ds320_wn_basetts.sh
...
# tag="_encodec_0518"
# tag="_encodec-2gpu"
# tag="_no_embed_l2_norm_encodec-2gpu"
tag="_1.0_encodec-2gpu"
# tag="_encodec-4gpu"
train_set=train
valid_set=dev
train_config=/home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/codec/conf/user/2rvq_encodec/encodec_16k_n6_ds320_wn_basetts.yaml
init_param=/home/admin_data/user/checkpoints/funcodec_consistency_encodec_LibriTTS+MLS_en/exp/encodec_16k_n6_ds320_wn_encodec-2gpu/1epoch.pth
...
if [ ! -z "${init_param}" ]; then
    ...
    # init_opt="--init_param ${init_param}:encoder:encoder"
    # echo ${init_opt}
fi
