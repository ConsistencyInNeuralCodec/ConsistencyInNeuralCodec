...
# 执行命令: bash /home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/codec/scripts/user/submit/2rvq_encodec/encodec_16k_n2_ds320_wn_adain_praat_frame_cl.sh
...
tag="_0.1_encodec-2gpu"
# tag="_encodec-4gpu"
train_set=train
valid_set=dev
train_config=/home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/codec/conf/user/2rvq_encodec/encodec_16k_n2_ds320_wn_adain_praat_frame_cl.yaml
init_param=
