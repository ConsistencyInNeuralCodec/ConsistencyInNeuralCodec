...
# 执行命令: bash /home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/codec/scripts/user/submit/2rvq_encodec/encodec_8192_fastspeech_mel_qformer1_praat_frame_cl.sh
...
train_config=/home/admin_data/user/model/uniaudio_admin/FunCodec-Dev/egs/LibriTTS/codec/conf/user/2rvq_encodec/encodec_8192_fastspeech_mel_qformer1_praat_frame.yaml
init_param=
